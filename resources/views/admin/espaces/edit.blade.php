...
<div class="espace-form-container">
    ...
    <form action="{{ route('admin.espaces.update', $espace) }}" method="POST" class="espace-form">
        @csrf
        @method('PUT')
        ...
        <div class="form-grid">
            ...
            <div class="form-section">
                <div class="section-header">
                    ...
                    <p>Modifiez les informations principales de l'espace</p>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" 
                              class="form-textarea" 
                              rows="4"
                              placeholder="Description détaillée de l'espace, son utilisation, ses équipements...">{{ old('description', $espace->description) }}</textarea>
                    @error('description')
                        <div class="form-error">{{ $message }}</div>
                    @enderror
                </div>
        ...
        <div class="form-actions">
            ...
            <a href="{{ route('admin.espaces.show', $espace) }}" class="btn btn-outline btn-lg">
                <i class="fas fa-eye"></i>
                Voir les détails
            </a>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Afficher l'aperçu si l'email existe déjà
